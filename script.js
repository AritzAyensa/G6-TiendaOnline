...
producto1 = new Producto(1, "Xiaomi Redmi Note 13 8/256GB Azul Libre", "Smartphone con cámara de 108 MP, pantalla de 6.7' y almacenamiento de 256 GB.", "390€", "images/movil.jpg");
producto2 = new Producto(2, "PcCom Ready Intel Core i5-12400F", "PC gaming de alto rendimiento con procesador Intel i5, 32 GB de RAM y tarjeta gráfica RTX 4060 Ti.", "900€", "images/pc.jpg");
producto3 = new Producto(3, "Nintendo Switch OLED Blanca + Mario Kart 8 Deluxe", "Consola híbrida Nintendo Switch OLED con pantalla de 7' y el juego Mario Kart 8 Deluxe.", "290€", "images/nintendo.jpg");
producto4 = new Producto(4, 'Monitor LG UltraGear 24GS50F-B 23.7" LED VA FullHD 180Hz FreeSync', "Monitor gamer con resolución Full HD y tasa de refresco de 180Hz, ideal para juegos rápidos.", "345€", "images/pantalla.jpg");
producto5 = new Producto(5, "Microsoft Xbox Series S 512GB Blanca", "Consola de videojuegos compacta con 512 GB de almacenamiento, ideal para juegos de última generación.", "249€", "images/xBox.jpg");
producto6 = new Producto(6, "Logitech G PRO X SUPERLIGHT 2", "Ratón gaming ultraligero de alto rendimiento con sensor preciso, diseñado para jugadores profesionales.", "180€", "images/raton.jpg");
